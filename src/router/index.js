...
import Live from '../pages/live/index.vue'/* 直播间 */
...
import Detail  from '../pages/home/detail'/* 详情 */
import FangPian  from '../pages/game/fangpian'/* 防骗指南 */
...
const routes = [
    ...
    {path:'/Live',name:'live',component:Live,meta:{title:'直播间'}},
    ...
    {path:'/FangPian',name:'FangPian',component:FangPian},
