<template>
  <div class="container page">
    <van-nav-bar :title="$t('设置资金密码')" class="nav-bar">
      <template #left>
    ...
    <div class="wrapper">
        ...
        <van-button class="sub-btn" type="default" @click="setPayPassword()">{{ $t('提交') }}</van-button>
    </div>
  </div>
</template>
